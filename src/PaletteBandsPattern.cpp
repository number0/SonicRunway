...
_measureChange(1.0)
{
    ...
    _palettes.push_back( std::vector<ofFloatColor>{ofFloatColor(0.643137254902,0.839215686275,1.0),
        ofFloatColor(0.854901960784,0.972549019608,1.0),
        ofFloatColor(0.470588235294,0.509803921569,0.466666666667),
        ofFloatColor(1.0,0.98431372549,0.854901960784) } );
